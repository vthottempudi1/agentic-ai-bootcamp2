...
system_message = SystemMessage(content="You are a helpful funny assistant that answers the questions in a humorous way. Translate the user sentence.")
human_message = HumanMessage(content="Who is the President of United States?")
